...
Use Power BI visuals to analyze the healthcare data and identify important patterns, such as:

* Count of patients by status
* Patient admissions and discharges
* Approved days versus actual stay
* Patients requiring extensions
...
Create an interactive Power BI dashboard using suitable visuals, such as:

* **Cards** – Total Patients, Admitted Patients, Discharged Patients
* **Bar Charts** – Patients by status and insurance
* **Pie/Donut Chart** – Authorization and extension status
* **Column Chart** – Approved days and patient stay
* **Table** – Patient details and cases requiring attention
* **Slicers** – Patient status, insurance, authorization, and date

Use slicers and filters to allow users to interact with the dashboard and view specific patient information.

### 7. Identify Insights and Recommendations

Analyze the dashboard results and identify important findings, such as:

* Patients with extended stays
* Patients nearing or exceeding approved days
* Pending authorization cases
* Patients requiring follow-up
* Insurance-wise patient patterns

Provide suitable recommendations to improve patient tracking, authorization management, and hospital operations.

## Output :

<img width="1058" height="568" alt="image" src="https://github.com/user-attachments/assets/166cac62-5f37-4f95-855a-3f85fc4b05e1" />
